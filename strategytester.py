...
# Mirrors ladder_calculator.py section styling (one rectangle per section)
...
# ---------- CSS (copied style model from your ladder app) ----------
st.markdown("""
<style>
  * { font-family: Helvetica, Arial, sans-serif !important; }
  ...
  /* Section boxes — style ONLY the Streamlit containers that have a border */
